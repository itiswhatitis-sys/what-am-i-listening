     ...
     <section className="bg-[#0d0d12] w-full py-4 z-20 top-0 left-0 ">
         <div className="max-w-7xl mx-auto">
          <div className=" flex flex-row p-1">
                    ...
                    <div className="text-xl mt-2 px-2 font-semibold text-gray-200">
                    Murali
                    </div>
            <div className="ml-8  mt-2 text-lg font-medium">Home</div>
            <div className="ml-4  mt-2 text-lg font-medium">About</div>
